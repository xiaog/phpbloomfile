...
dnl If your extension references something external, use with:
 ...
 PHP_ARG_WITH(bloom_filter, for bloom_filter support,
dnl Make sure that the comment is aligned:
[  --with-bloom_filter             Include bloom_filter support])

dnl Otherwise use enable:

dnl PHP_ARG_ENABLE(bloom_filter, whether to enable bloom_filter support,
dnl Make sure that the comment is aligned:
dnl [  --enable-bloom_filter           Enable bloom_filter support])
